namespace Valvrave_Sharp.Plugin
{
    ...
    internal class Yasuo : Program
    {
        ...
        public Yasuo()
        {
            Q = new Spell(SpellSlot.Q, 475).SetSkillshot(QDelay, 20, float.MaxValue, false, SkillshotType.SkillshotLine);
            Q2 = new Spell(Q.Slot, 900).SetSkillshot(Q2Delay, 90, 1200, false, Q.Type);
            ...
            Q.MinHitChance = Q2.MinHitChance = HitChance.Medium;
