...
namespace HeavenStrikeLuLu
{
    class Program
    {
        ...
        private static void Game_OnGameLoad(EventArgs args)
        {
            ...
            _q2.MinHitChance = HitChance.High;
            ...
            Harass.AddItem(new MenuItem("EH", "E").SetValue(false));
            ...
            Combo.AddItem(new MenuItem("EC", "E").SetValue(false));
            Combo.AddItem(new MenuItem("QEC", "E+Q").SetValue(false));
